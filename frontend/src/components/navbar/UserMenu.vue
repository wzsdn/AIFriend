...
<template>
    <div class="dropdown  dropdown-end">
      ...
      <ul tabindex="-1" class="dropdown-content menu bg-base-100 rounded-box z-1 w-42 p-2 shadow-lg">
        <li>
        ...
        <li class="divider"></li>
        <li>
          <div @click="handleLogout" class="text-base font-bold py-3 active:bg-black/20 active:scale-[0.98] transition-colors">
            <UserLogoutIcon/>
            退出登录
          </div>
        </li>
